...
export function StickerItem({ sticker, className, isPlaceholder, positionNumber }: StickerItemProps) {
  ...
  if (isPlaceholder) {
    return (
      <div className={cn("w-full aspect-[3/4] bg-white/5 rounded-xl border-2 border-dashed border-white/20 relative shadow-sm backdrop-blur-sm", className)}>
        <svg viewBox="0 0 250 333" className="w-full h-full absolute inset-0">
          <foreignObject x="0" y="0" width="250" height="333">
  ...
  return (
    <div className={cn("w-full aspect-[3/4] relative", className)}>
      <svg viewBox="0 0 250 333" className="w-full h-full absolute inset-0 overflow-visible">
        <foreignObject x="0" y="0" width="250" height="333">
          <div className={cn(
